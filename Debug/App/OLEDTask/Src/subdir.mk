...
C_SRCS += \
../App/OLEDTask/Src/oled_task.c 

OBJS += \
./App/OLEDTask/Src/oled_task.o 

C_DEPS += \
./App/OLEDTask/Src/oled_task.d 


# Each subdirectory must supply rules for building sources it contributes
App/OLEDTask/Src/%.o App/OLEDTask/Src/%.su App/OLEDTask/Src/%.cyclo: ../App/OLEDTask/Src/%.c App/OLEDTask/Src/subdir.mk
...
clean: clean-App-2f-OLEDTask-2f-Src

clean-App-2f-OLEDTask-2f-Src:
	-$(RM) ./App/OLEDTask/Src/oled_task.cyclo ./App/OLEDTask/Src/oled_task.d ./App/OLEDTask/Src/oled_task.o ./App/OLEDTask/Src/oled_task.su

.PHONY: clean-App-2f-OLEDTask-2f-Src
